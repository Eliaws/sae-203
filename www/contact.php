...
if ($formulaire_soumis) {
    ...
    if ($formulaire_soumis) {
        ...
        $sujet = "Bonne réception de votre message";
        $contenu = "Bonjour $prenom $nom, nous avons bien reçu votre message et nous l'avons rangé dans la catégorie $je_suis";
...
<head>
    ...
    <title>Speak'n'Dev - Contact</title>
...
<body>
    <section>
        ...
        if ($formulaire_soumis && !$formulaire_a_erreurs) {
            ...
            ";                                                                                      //verifie si le formulaire contient des manquement
        }
        if ($formulaire_soumis && $formulaire_a_erreurs) {
            echo "
