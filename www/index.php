...
$listeArticlesCommande = $clientMySQL->prepare('SELECT * FROM article ORDER BY id DESC');   //trie les articles creer du plus recent au plus ancien
...
<head>
    ...
    <title>Speak'n'Dev - Accueil </title>
